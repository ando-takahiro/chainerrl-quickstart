...
class GPU_A3C(agent.AttributeSavingMixin, agent.AsyncAgent):
    ...
    def act_and_train(self, state, reward):
        ...
        statevar = self.batch_states([state], self.model.xp, self.phi)
    ...
    def act(self, obs):
        ...
        with chainer.no_backprop_mode():
            statevar = self.batch_states([obs], self.model.xp, self.phi)
